...
class TransaksiController extends Controller
{
    ...
    {
        $dataSupplier = User::getSupplierById();
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->id_product as $id_products) {
            ...
            $transaksi_item = new TransaksiItems();
            $transaksi_item->fill([
                'transaksi_id' => $kodeTransaksi,
                'id_dTransaksi' => $id_products,
    ...
    {
        $products = Product::where('id_user', $supplier_id)->get();
        return response()->json($products);
    }

    // public function exportItemsPdf($id)
    // {
    //     $data = TransaksiItems::where('id_transaksi', $id)->get();
